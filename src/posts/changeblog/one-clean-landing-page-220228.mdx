...
description: Every portfolio starts somewhere. This is the first step towards the goal of building a fast, lightweight, but still comprehensive (and kickass) collection of my work.
metaImageUrl: https://jimburch-portfolio.s3.us-west-1.amazonaws.com/mdx-featured-images/one-clean-landing-page.jpg
metaImageAlt: Dark computer setup with code on the screen
---
